...
def _ensure_ffmpeg_available():
    """Make sure ffmpeg/ffprobe are available to pydub."""
    ...
    for candidate in candidates:
        ...
        ffprobe_path = os.path.join(candidate, "ffprobe.exe")
...
def ensure_stereo(audio_path: str) -> str:
    ...
    if not _ensure_ffmpeg_available():
        raise RuntimeError(
            ...
            "or place ffmpeg.exe and ffprobe.exe in a common folder like C:\\ffmpeg\\bin."
        )
