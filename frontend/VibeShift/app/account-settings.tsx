            ...
            <View style={styles.contentWrap}>
              ...
              >
                ...
                <View style={styles.optionInfo}>
                  ...
                  <Text style={styles.optionSubtitle}>Name, avatar, bio</Text>
                </View>
              ...
              >
                ...
                <View style={styles.optionInfo}>
                  ...
                  <Text style={styles.optionSubtitle}>Update your password</Text>
                </View>
                <Icon name="arrow-right" size={20} color="rgba(255,255,255,0.5)" />
              </Pressable>
              ...
              >
                ...
                <View style={styles.optionInfo}>
                  <Text style={styles.optionTitle}>Linked Accounts</Text>
                  <Text style={styles.optionSubtitle}>Google, Apple, Spotify</Text>
                </View>
                <Icon name="arrow-right" size={20} color="rgba(255,255,255,0.5)" />
              </Pressable>
            </View>
